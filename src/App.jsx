  ...
  es:{ flag:"🇪🇸", lp:"español",
    ...
    plans:[
      {id:"free",name:"Free",price:"Gratis",period:"",highlight:false,
        features:["2 análisis/semana","Solo texto","8 idiomas"],cta:"Plan actual"},
      ...
      {id:"empresa",name:"Empresa",price:"29€",period:"/mes",highlight:false,
        features:["Todo lo de Personal","Hasta 10 usuarios","Historial","API access","Soporte prioritario"],
  ...
  en:{ flag:"🇬🇧", lp:"English",
    ...
    plans:[
      {id:"free",name:"Free",price:"Free",period:"",highlight:false,
        features:["2 analyses/week","Text only","8 languages"],cta:"Current plan"},
      ...
      {id:"empresa",name:"Business",price:"€29",period:"/mo",highlight:false,
        features:["Everything in Personal","Up to 10 users","History","API access","Priority support"],
  ...
  fr:{ flag:"🇫🇷", lp:"français",
    ...
    plans:[
      {id:"free",name:"Gratuit",price:"Gratuit",period:"",highlight:false,
        features:["2 analyses/semaine","Texte uniquement","8 langues"],cta:"Plan actuel"},
      {id:"personal",name:"Personnel",price:"5€",period:"/mois",highlight:true,
        features:["Analyses illimitées","PDF + photos + caméra","Audio","Exporter PDF","8 langues"],
        cta:"S'abonner →",latam:"3€/mois en Amérique latine"},
      {id:"empresa",name:"Entreprise",price:"29€",period:"/mois",highlight:false,
        features:["Tout Personnel","Jusqu'à 10 utilisateurs","Historique","API","Support"],
  ...
  pt:{ flag:"🇧🇷", lp:"português",
    ...
    plans:[
      {id:"free",name:"Grátis",price:"Grátis",period:"",highlight:false,
        features:["2 análises/semana","Somente texto","8 idiomas"],cta:"Plano atual"},
      {id:"personal",name:"Pessoal",price:"5€",period:"/mês",highlight:true,
        features:["Análises ilimitadas","PDF + fotos + câmera","Áudio","Exportar PDF","8 idiomas"],
        cta:"Assinar →",latam:"3€/mês na América Latina"},
      {id:"empresa",name:"Empresa",price:"29€",period:"/mês",highlight:false,
        features:["Tudo do Pessoal","Até 10 usuários","Histórico","API","Suporte"],
  ...
  de:{ flag:"🇩🇪", lp:"Deutsch",
    ...
    plans:[
      {id:"free",name:"Kostenlos",price:"Kostenlos",period:"",highlight:false,
        features:["2 Analysen/Woche","Nur Text","8 Sprachen"],cta:"Aktueller Plan"},
      {id:"personal",name:"Persönlich",price:"5€",period:"/Monat",highlight:true,
        features:["Unbegrenzte Analysen","PDF + Fotos + Kamera","Audio","PDF exportieren","8 Sprachen"],
        cta:"Abonnieren →",latam:"3€/Monat in Lateinamerika"},
      {id:"empresa",name:"Unternehmen",price:"29€",period:"/Monat",highlight:false,
        features:["Alles Persönlich","Bis zu 10 Nutzer","Verlauf","API","Support"],
  ...
  it:{ flag:"🇮🇹", lp:"italiano",
    ...
    plans:[
      {id:"free",name:"Gratuito",price:"Gratuito",period:"",highlight:false,
        features:["2 analisi/settimana","Solo testo","8 lingue"],cta:"Piano attuale"},
      {id:"personal",name:"Personale",price:"5€",period:"/mese",highlight:true,
        features:["Analisi illimitate","PDF + foto + fotocamera","Audio","Esporta PDF","8 lingue"],
        cta:"Abbonati →",latam:"3€/mese in America Latina"},
      {id:"empresa",name:"Azienda",price:"29€",period:"/mese",highlight:false,
        features:["Tutto Personale","Fino a 10 utenti","Storico","API","Supporto"],
  ...
  ru:{ flag:"🇷🇺", lp:"русском языке",
    ...
    plans:[
      {id:"free",name:"Бесплатно",price:"Бесплатно",period:"",highlight:false,
        features:["2 анализа/неделю","Только текст","8 языков"],cta:"Текущий план"},
      {id:"personal",name:"Личный",price:"5€",period:"/мес",highlight:true,
        features:["Безлимитные анализы","PDF + фото + камера","Аудио","Экспорт PDF","8 языков"],
        cta:"Подписаться →",latam:"3€/мес в Латинской Америке"},
      {id:"empresa",name:"Бизнес",price:"29€",period:"/мес",highlight:false,
        features:["Всё из Личного","До 10 пользователей","История","API","Поддержка"],
    ...
    <div style={{maxWidth:520,margin:"24px auto",padding:"0 20px"}}>
      <div style={{textAlign:"center",marginBottom:24,padding:"28px 24px",
        ...
        <div style={{display:"flex",gap:6,justifyContent:"center",flexWrap:"wrap"}}>
          {["📄 "+t.plans[0].features[0],"🌍 "+t.plans[0].features[2],"⬇ "+t.plans[1].features[3]].map((f,i)=>(
