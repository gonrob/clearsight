...
const T = {
  ...
  en:{ flag:"🇬🇧", lp:"English",
    tagline:"Upload contracts, fines, official letters and any legal document.",
  ...
  fr:{ flag:"🇫🇷", lp:"français",
    tagline:"Téléchargez contrats, amendes, courriers officiels et tout document légal.",
  ...
  pt:{ flag:"🇧🇷", lp:"português",
    tagline:"Envie contratos, multas, cartas oficiais e qualquer documento legal.",
  ...
  de:{ flag:"🇩🇪", lp:"Deutsch",
    tagline:"Laden Sie Verträge, Bußgelder, Behördenbriefe und alle Dokumente hoch.",
  ...
  it:{ flag:"🇮🇹", lp:"italiano",
    tagline:"Carica contratti, multe, lettere ufficiali e qualsiasi documento legale.",
  ...
  ru:{ flag:"🇷🇺", lp:"русском языке",
    tagline:"Загрузите договоры, штрафы, официальные письма и любые документы.",
