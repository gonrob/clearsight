...
const T = {
  es:{ flag:"🇪🇸", lp:"español",
    tagline:"Sube contratos, multas, cartas documento y cualquier escrito oficial que no entiendas.",
    sub:"DocPlain te lo explica en un vocabulario fácil de entender — los riesgos, lo que puedes negociar y qué preguntar.",
    ...
    upgradeBtn:"Ver planes", pricingTitle:"Elige tu plan",
    docsUsed:n=>`${n}/${FREE_LIMIT} análisis usados esta semana`,
    plans:[
      {id:"free",name:"Free",price:"Gratis",period:"",highlight:false,
        features:["2 análisis/semana","8 idiomas"],cta:"Plan actual"},
      {id:"personal",name:"Personal",price:"5€",period:"/mes",highlight:true,
        features:["Análisis ilimitados","Exportar PDF","Audio del resumen"],
        cta:"Suscribirse →",latam:"3€/mes en Latinoamérica"},
      {id:"empresa",name:"Empresa",price:"29€",period:"/mes",highlight:false,
        features:["Todo Personal","10 usuarios","Historial","API access"],
        cta:"Suscribirse →",latam:"15€/mes en Latinoamérica"},
    ],
  },
  en:{ flag:"🇬🇧", lp:"English",
    tagline:"Upload contracts, fines, official letters and any document you don't understand.",
    sub:"DocPlain explains it in plain language — the risks, what to negotiate and what to ask.",
    ...
    upgradeBtn:"See plans", pricingTitle:"Choose your plan",
    docsUsed:n=>`${n}/${FREE_LIMIT} analyses used this week`,
    plans:[
      {id:"free",name:"Free",price:"Free",period:"",highlight:false,
        features:["2 analyses/week","8 languages"],cta:"Current plan"},
      {id:"personal",name:"Personal",price:"€5",period:"/mo",highlight:true,
        features:["Unlimited analyses","Export PDF","Audio summary"],
        cta:"Subscribe →",latam:"€3/mo in Latin America"},
      {id:"empresa",name:"Business",price:"€29",period:"/mo",highlight:false,
        features:["All Personal","10 users","History","API access"],
        cta:"Subscribe →",latam:"€15/mo in Latin America"},
    ],
  },
  fr:{ flag:"🇫🇷", lp:"français",
    tagline:"Téléchargez contrats, amendes, courriers officiels et tout document que vous ne comprenez pas.",
    sub:"DocPlain vous l'explique en langage simple — les risques, ce que vous pouvez négocier et quoi demander.",
    ...
    analyzeBtn:"Analyser ✦", analyzing:"Analyse en cours...",
    ...
    listenBtn:"🔊 Écouter", listeningBtn:"🔊 En cours...",
    ...
    upgradeBtn:"Voir les plans", pricingTitle:"Choisissez votre plan",
    docsUsed:n=>`${n}/${FREE_LIMIT} analyses utilisées cette semaine`,
    plans:[
      {id:"free",name:"Gratuit",price:"Gratuit",period:"",highlight:false,
        features:["2 analyses/semaine","8 langues"],cta:"Plan actuel"},
      {id:"personal",name:"Personnel",price:"5€",period:"/mois",highlight:true,
        features:["Analyses illimitées","Exporter PDF","Résumé audio"],
        cta:"S'abonner →",latam:"3€/mois en Amérique latine"},
      {id:"empresa",name:"Entreprise",price:"29€",period:"/mois",highlight:false,
        features:["Tout Personnel","10 utilisateurs","Historique","API"],
        cta:"S'abonner →",latam:"15€/mois en Amérique latine"},
    ],
  },
  pt:{ flag:"🇧🇷", lp:"português",
    tagline:"Envie contratos, multas, cartas oficiais e qualquer documento que você não entenda.",
    sub:"DocPlain explica em linguagem simples — os riscos, o que negociar e o que perguntar.",
    ...
    analyzeBtn:"Analisar ✦", analyzing:"Analisando...",
    ...
    listenBtn:"🔊 Ouvir", listeningBtn:"🔊 Reproduzindo...",
    exportBtn:"⬇ Exportar PDF",
    ...
    upgradeBtn:"Ver planos", pricingTitle:"Escolha seu plano",
    docsUsed:n=>`${n}/${FREE_LIMIT} análises usadas esta semana`,
    plans:[
      {id:"free",name:"Grátis",price:"Grátis",period:"",highlight:false,
        features:["2 análises/semana","8 idiomas"],cta:"Plano atual"},
      {id:"personal",name:"Pessoal",price:"5€",period:"/mês",highlight:true,
        features:["Análises ilimitadas","Exportar PDF","Áudio do resumo"],
        cta:"Assinar →",latam:"3€/mês na América Latina"},
      {id:"empresa",name:"Empresa",price:"29€",period:"/mês",highlight:false,
        features:["Tudo Pessoal","10 usuários","Histórico","API"],
        cta:"Assinar →",latam:"15€/mês na América Latina"},
    ],
  },
  de:{ flag:"🇩🇪", lp:"Deutsch",
    tagline:"Laden Sie Verträge, Bußgelder, Behördenbriefe und alle Dokumente hoch, die Sie nicht verstehen.",
    sub:"DocPlain erklärt es in einfacher Sprache — die Risiken, was Sie verhandeln und was Sie fragen können.",
    ...
    analyzeBtn:"Analysieren ✦", analyzing:"Analysiere...",
    ...
    listenBtn:"🔊 Anhören", listeningBtn:"🔊 Wird abgespielt...",
    ...
    upgradeBtn:"Pläne ansehen", pricingTitle:"Wählen Sie Ihren Plan",
    docsUsed:n=>`${n}/${FREE_LIMIT} Analysen diese Woche verwendet`,
    plans:[
      {id:"free",name:"Kostenlos",price:"Kostenlos",period:"",highlight:false,
        features:["2 Analysen/Woche","8 Sprachen"],cta:"Aktueller Plan"},
      {id:"personal",name:"Persönlich",price:"5€",period:"/Monat",highlight:true,
        features:["Unbegrenzte Analysen","PDF exportieren","Audio-Zusammenfassung"],
        cta:"Abonnieren →",latam:"3€/Monat in Lateinamerika"},
      {id:"empresa",name:"Unternehmen",price:"29€",period:"/Monat",highlight:false,
        features:["Alles Persönlich","10 Nutzer","Verlauf","API"],
        cta:"Abonnieren →",latam:"15€/Monat in Lateinamerika"},
    ],
  },
  it:{ flag:"🇮🇹", lp:"italiano",
    tagline:"Carica contratti, multe, lettere ufficiali e qualsiasi documento che non capisci.",
    sub:"DocPlain te lo spiega in linguaggio semplice — i rischi, cosa puoi negoziare e cosa chiedere.",
    ...
    analyzeBtn:"Analizza ✦", analyzing:"Analisi in corso...",
    ...
    listenBtn:"🔊 Ascolta", listeningBtn:"🔊 In riproduzione...",
    ...
    upgradeBtn:"Vedi piani", pricingTitle:"Scegli il tuo piano",
    docsUsed:n=>`${n}/${FREE_LIMIT} analisi usate questa settimana`,
    plans:[
      {id:"free",name:"Gratuito",price:"Gratuito",period:"",highlight:false,
        features:["2 analisi/settimana","8 lingue"],cta:"Piano attuale"},
      {id:"personal",name:"Personale",price:"5€",period:"/mese",highlight:true,
        features:["Analisi illimitate","Esporta PDF","Audio del riepilogo"],
        cta:"Abbonati →",latam:"3€/mese in America Latina"},
      {id:"empresa",name:"Azienda",price:"29€",period:"/mese",highlight:false,
        features:["Tutto Personale","10 utenti","Storico","API"],
        cta:"Abbonati →",latam:"15€/mese in America Latina"},
    ],
  },
  ru:{ flag:"🇷🇺", lp:"русском языке",
    tagline:"Загрузите договоры, штрафы, официальные письма и любые документы, которые вы не понимаете.",
    sub:"DocPlain объяснит простым языком — риски, что можно обсудить и что спросить.",
    ...
    upgradeBtn:"Посмотреть планы", pricingTitle:"Выберите план",
    ...
    plans:[
      {id:"free",name:"Бесплатно",price:"Бесплатно",period:"",highlight:false,
        features:["2 анализа/неделю","8 языков"],cta:"Текущий план"},
      {id:"personal",name:"Личный",price:"5€",period:"/мес",highlight:true,
        features:["Безлимитные анализы","Экспорт PDF","Аудио резюме"],
        cta:"Подписаться →",latam:"3€/мес в Латинской Америке"},
      {id:"empresa",name:"Бизнес",price:"29€",period:"/мес",highlight:false,
        features:["Всё Личного","10 пользователей","История","API"],
        cta:"Подписаться →",latam:"15€/мес в Латинской Америке"},
    ],
  },
  zh:{ flag:"🇨🇳", lp:"中文",
    tagline:"上传合同、罚款、官方信函及任何您不理解的文件。",
    sub:"DocPlain用简单易懂的语言解释——风险、可协商内容和应提问题。",
...
function getWeekKey(uid) {
  ...
  return `dp_${d.getFullYear()}_w${w}_${uid}`;
}
...
function exportPDF(result, lang) {
  ...
  const html = `<html><head><meta charset="utf-8"><style>
    ...
    h1{font-size:24px;margin-bottom:4px}h2{font-size:16px;margin:20px 0 8px;color:#2D5016}
    .v{display:inline-block;padding:4px 14px;border-radius:20px;font-size:13px;font-weight:700;margin-bottom:16px}
    .FAVORABLE,.FAVORABLE{background:#d4edda;color:#2D5016}.NEUTRO,.NEUTRAL{background:#fff3cd;color:#856404}
    .DESFAVORABLE,.UNFAVORABLE{background:#f8d7da;color:#721c24}
    ul{padding-left:20px}li{margin-bottom:6px;font-size:14px}
    .sum{font-style:italic;font-size:15px;border-left:3px solid #C4922A;padding-left:16px;margin:16px 0}
    .foot{margin-top:40px;font-size:11px;color:#999;border-top:1px solid #eee;padding-top:12px}
  </style></head><body>
  <h1>${result.title||"Análisis"}</h1>
  <span class="v ${result.verdict||""}">${result.verdict||""}</span>
  <p style="color:#666;font-size:13px">${result.verdictReason||""}</p>
  <h2>${t.summaryTitle}</h2><div class="sum">${result.summary||""}</div>
  ...
  <div class="foot">DocPlain · docplain.com · ${new Date().toLocaleDateString()} · ${t.disclaimer}</div>
  </body></html>`;
...
function Logo({size=32}) {
  return (
    <svg width={size*4} height={size*4} viewBox="0 0 200 200" fill="none" style={{flexShrink:0}}>
      <path d="M20 0 L140 0 L180 40 L180 200 L20 200 Z" fill="#2D5016" opacity=".08" stroke="#C4922A" strokeWidth="3" strokeLinejoin="round"/>
      <path d="M140 0 L140 40 L180 40" fill="none" stroke="#C4922A" strokeWidth="3" strokeLinejoin="round"/>
      <line x1="44" y1="70" x2="120" y2="70" stroke="#C4922A" strokeWidth="3" strokeLinecap="round"/>
      <line x1="44" y1="90" x2="120" y2="90" stroke="#C4922A" strokeWidth="3" strokeLinecap="round"/>
      <line x1="44" y1="110" x2="90" y2="110" stroke="#C4922A" strokeWidth="3" strokeLinecap="round"/>
      <circle cx="140" cy="148" r="44" fill="none" stroke="#C4922A" strokeWidth="3"/>
      <rect x="108" y="136" width="26" height="22" rx="5" fill="none" stroke="#C4922A" strokeWidth="2.5"/>
      <path d="M114 147 l4 4.5 7-7" stroke="#C4922A" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
      <rect x="140" y="136" width="26" height="22" rx="5" fill="none" stroke="#C4922A" strokeWidth="2.5"/>
      <path d="M146 140 l14 14 M160 140 l-14 14" stroke="#C4922A" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
      <line x1="176" y1="172" x2="192" y2="188" stroke="#C4922A" strokeWidth="6" strokeLinecap="round"/>
    </svg>
  );
}
...
// ─── PRICING MODAL ────────────────────────────────────────────────────────────
function PricingModal({t,onClose}) {
  return (
      ...
      <div style={{background:C.paper,borderRadius:20,padding:24,maxWidth:500,
        ...
        {t.plans.map((plan,i)=>(
          <div key={plan.id} style={{border:`2px solid ${plan.highlight?C.accent:C.border}`,
            ...
            {plan.highlight&&<div style={{position:"absolute",top:-10,right:16,background:C.accent,
              color:"#fff",fontSize:10,fontWeight:700,padding:"3px 10px",borderRadius:20}}>POPULAR</div>}
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
              <div style={{fontSize:17,fontWeight:700,color:C.ink}}>{plan.name}</div>
              <div><span style={{fontSize:22,fontWeight:800,color:plan.highlight?C.accent:C.ink}}>{plan.price}</span>
                <span style={{fontSize:12,color:C.inkLight}}>{plan.period}</span></div>
            </div>
            ...
            {plan.id==="free"?(
              <div style={{padding:"9px",background:C.border,borderRadius:10,fontSize:13,fontWeight:600,textAlign:"center",color:C.inkLight}}>{plan.cta}</div>
            ):(
              <a href={plan.id==="personal"?"https://buy.stripe.com/eVq3cx0KQgTCcHS77Zdwc01":"https://buy.stripe.com/8x29AVcty7j2gY80JBdwc02"}
        ...
        <p style={{fontSize:11,color:C.inkLight,textAlign:"center",marginTop:4}}>
          🔒 Stripe · Pago seguro<br/>
          ✉️ <a href="mailto:gonrobtor@gmail.com" style={{color:C.accent}}>gonrobtor@gmail.com</a>
        </p>
      </div>
    </div>
  );
...
function Camera({onCapture,onClose}) {
  ...
  function capture(){
    ...
    c.toBlob(blob=>{
      if(blob){ streamRef.current?.getTracks().forEach(t=>t.stop()); onCapture(new File([blob],`photo_${Date.now()}.jpg`,{type:"image/jpeg"})); }
    },"image/jpeg",0.92);
  }
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"#000",zIndex:2000,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
      {err?(<div style={{color:"#fff",textAlign:"center",padding:20}}>
        ...
        <>
          ...
          <div style={{position:"fixed",bottom:0,left:0,right:0,padding:"20px 20px 40px",display:"flex",gap:12,justifyContent:"center",background:"rgba(0,0,0,.6)"}}>
            <button onClick={onClose} style={{padding:"12px 20px",background:"rgba(255,255,255,.2)",color:"#fff",border:"1px solid rgba(255,255,255,.3)",borderRadius:12,fontSize:14,cursor:"pointer"}}>✕</button>
            <button onClick={capture} disabled={!ready} style={{padding:"12px 32px",background:ready?"#C4922A":"#555",color:"#fff",border:"none",borderRadius:12,fontSize:15,fontWeight:700,cursor:ready?"pointer":"not-allowed"}}>📷 Capturar</button>
          </div>
        </>
      )}
    </div>
...
export default function App() {
  ...
  async function analyze() {
    ...
    // Admin has NO limit
    if(!isAdmin && usage>=FREE_LIMIT){ setLimitHit(true); return; }
    ...
    const outLang = langMap[lang]||"español";
    const schema = `{"title":"...","summary":"...3-4 frases simples...","risks":["..."],"good":["..."],"watch":["..."],"negotiate":["..."],"questions":["..."],"verdict":"FAVORABLE|NEUTRO|DESFAVORABLE","verdictReason":"..."}`;
    ...
    if(pages.length>0){
      ...
      if(text.trim()) content.push({type:"text",text:`Notas: ${text.trim()}`});
      content.push({type:"text",text:`Tipo: ${docType||"documento legal"}. Analiza todo. Responde SOLO este JSON en ${outLang}: ${schema}`});
      messages=[{role:"user",content}];
    } else {
      messages=[{role:"user",content:`Tipo: ${docType||"documento legal"}.\n${text.trim()}\n\nResponde SOLO este JSON en ${outLang}: ${schema}`}];
    }
    ...
    try{
      const r=await fetch("/api/anthropic",{
        ...
        body:JSON.stringify({model:"claude-sonnet-4-5",max_tokens:3000,
          system:`Experto legal. Ayuda a personas comunes. Responde SOLO JSON válido en ${outLang} sin markdown.`,
          messages})
      });
      ...
      // Only count usage for non-admin
      if(!isAdmin){ const newU=incUsage(user.id); if(mounted.current) setUsage(newU); }
      if(mounted.current) setResult(parsed);
    }catch(e){
      if(mounted.current) setError(t.errorMsg);
    }
    ...
    <header style={{background:C.paper,borderBottom:`1px solid ${C.border}`,padding:"0 16px",
      ...
      <div style={{maxWidth:680,margin:"0 auto",height:56,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <Logo size={10}/>
          <span style={{fontSize:17,fontWeight:400,fontFamily:"Georgia,'Times New Roman',serif",color:C.gold,letterSpacing:1}}>DocPlain</span>
        </div>
  ...
  if(!isSignedIn) return(
    ...
    <div style={{maxWidth:520,margin:"24px auto",padding:"0 20px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:20}}>
        {t.plans.map((plan,i)=>(
          <div key={plan.id} style={{padding:"12px 10px",textAlign:"center",
            ...
            border:`1.5px solid ${i===1?C.accent:C.border}`,borderRadius:12,position:"relative"}}>
            {i===1&&<div style={{position:"absolute",top:-8,left:"50%",transform:"translateX(-50%)",
              background:C.gold,color:"#fff",fontSize:9,fontWeight:800,padding:"2px 8px",borderRadius:10,whiteSpace:"nowrap"}}>POPULAR</div>}
      ...
      <div style={{background:C.paper,borderRadius:16,padding:24,border:`1px solid ${C.border}`,boxShadow:`0 4px 20px ${C.shadow}`}}>
        ...
        {authMode==="signin"?<SignIn routing="hash" afterSignInUrl="/"/>:<SignUp routing="hash" afterSignUpUrl="/"/>}
      </div>
      <button onClick={()=>setShowPricing(true)}
        style={{width:"100%",marginTop:16,padding:"12px",background:"transparent",
          border:`1px solid ${C.border}`,borderRadius:12,cursor:"pointer",fontSize:13,color:C.inkLight}}>
        {t.pricingTitle} →
      </button>
    </div>
  ...
  return(
    ...
    {limitHit&&(
      <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.7)",zIndex:900,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
        <div style={{background:C.paper,borderRadius:20,padding:28,maxWidth:380,textAlign:"center",boxShadow:"0 20px 60px rgba(0,0,0,.3)"}}>
          ...
          <button onClick={()=>{setShowPricing(true);setLimitHit(false);}}
            style={{width:"100%",padding:"12px",background:GG,color:"#fff",border:"none",borderRadius:12,fontSize:15,fontWeight:700,cursor:"pointer",marginBottom:10}}>
            {t.upgradeBtn}
          </button>
          <button onClick={()=>setLimitHit(false)}
            style={{width:"100%",padding:"10px",background:"transparent",color:C.inkLight,border:`1px solid ${C.border}`,borderRadius:12,fontSize:13,cursor:"pointer"}}>
            Cerrar
          </button>
        </div>
      </div>
    ...
    <main style={{maxWidth:680,margin:"0 auto",padding:"28px 16px 80px"}}>
      ...
      {/* Usage bar - hidden for admin */}
      {!result&&!analyzing&&!isAdmin&&(
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",
          marginBottom:16,padding:"8px 14px",background:C.paper,borderRadius:10,border:`1px solid ${C.border}`}}>
          <span style={{fontSize:12,color:C.inkLight}}>{t.docsUsed(usage)}</span>
          <div style={{display:"flex",gap:4}}>
            {Array.from({length:FREE_LIMIT}).map((_,i)=>(
              <div key={i} style={{width:16,height:16,borderRadius:"50%",background:i<usage?C.accent:C.border}}/>
            ))}
          </div>
        </div>
      )}
      ...
      {!result&&!analyzing&&(
        <div className="fade">
          <div style={{textAlign:"center",marginBottom:24}}>
            <h1 style={{fontSize:"clamp(20px,5vw,32px)",fontWeight:700,color:C.ink,lineHeight:1.2}}>{t.tagline}</h1>
            <p style={{fontSize:14,color:C.inkLight,marginTop:6,lineHeight:1.5}}>{t.sub}</p>
          </div>

          {/* Doc type */}
          <div style={{marginBottom:14}}>
            <div style={{fontSize:12,fontWeight:600,color:C.inkLight,marginBottom:8}}>{t.docTypeLabel}</div>
          ...
          <div style={{display:"flex",gap:8,marginBottom:10}}>
            <button onClick={()=>setShowCamera(true)}
              style={{flex:1,padding:"10px",background:C.paper,border:`1px solid ${C.border}`,borderRadius:10,cursor:"pointer",fontSize:13,fontWeight:600,color:C.inkLight}}>
              {t.cameraBtn}
            </button>
            ...
            <input ref={fileInputRef} type="file" accept=".pdf,image/*" multiple style={{display:"none"}} onChange={e=>addFiles(e.target.files)}/>
          </div>

          {/* Drop zone */}
          <div onDragOver={e=>{e.preventDefault();setDragging(true);}}
            onDragLeave={()=>setDragging(false)} onDrop={handleDrop}
            style={{border:`2px dashed ${dragging?C.accent:pages.length?C.accentL||C.accent:C.border}`,
                  ...
                  {pages.map((p,i)=>(
                    <div key={i} style={{position:"relative"}}>
                      {p.preview?(
                        ...
                        <div style={{width:56,height:56,background:C.accentDim,borderRadius:8,border:`2px solid ${C.accent}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:20}}>📄</div>
                      )}
                      <button onClick={e=>{e.stopPropagation();setPages(prev=>prev.filter((_,j)=>j!==i));}}
                        style={{position:"absolute",top:-6,right:-6,width:18,height:18,borderRadius:"50%",background:C.red,border:"none",color:"#fff",cursor:"pointer",fontSize:10,display:"flex",alignItems:"center",justifyContent:"center"}}>✕</button>
                    </div>
                  ))}
                  <button onClick={e=>{e.stopPropagation();fileInputRef.current?.click();}}
                    style={{width:56,height:56,borderRadius:8,border:`2px dashed ${C.border}`,background:"transparent",cursor:"pointer",fontSize:20,color:C.inkLight}}>+</button>
                </div>
          ...
          {error&&(
            <div style={{marginTop:10,padding:"10px 14px",background:C.redDim,border:`1px solid ${C.red}`,borderRadius:10,fontSize:13,color:C.red}}>{error}</div>
          )}
          ...
          <p style={{textAlign:"center",fontSize:11,color:C.inkLight,marginTop:10,lineHeight:1.5}}>{t.disclaimer}</p>
        </div>
      )}
      ...
      {analyzing&&(
        <div className="fade">
          <div style={{display:"flex",alignItems:"center",gap:12,padding:"14px 18px",background:C.paper,borderRadius:12,border:`1px solid ${C.border}`,marginBottom:16}}>
            <div style={{width:18,height:18,border:`2.5px solid ${C.accent}`,borderTopColor:"transparent",borderRadius:"50%",animation:"spin .8s linear infinite",flexShrink:0}}/>
      ...
      {result&&!analyzing&&(
        <div className="fade">
          ...
          <div style={{background:C.paper,border:`2px solid ${verdictColor}`,borderRadius:16,
            ...
            <div style={{flex:1}}>
              <div style={{fontSize:11,fontWeight:700,color:verdictColor,letterSpacing:".1em",textTransform:"uppercase",marginBottom:3}}>{result.verdict}</div>
          ...
          <div style={{background:C.paper,borderRadius:14,padding:"18px 20px",border:`1px solid ${C.border}`,marginBottom:12}}>
            ...
            <div style={{display:"flex",gap:8,marginTop:12,flexWrap:"wrap"}}>
              <button onClick={listen} disabled={speaking}
                style={{padding:"7px 14px",background:C.accentDim,border:`1px solid ${C.accent}`,borderRadius:8,cursor:"pointer",fontSize:12,fontWeight:600,color:C.accent}}>
                {speaking?t.listeningBtn:t.listenBtn}
              </button>
              <button onClick={()=>exportPDF(result,lang)}
                style={{padding:"7px 14px",background:C.goldDim,border:`1px solid ${C.gold}`,borderRadius:8,cursor:"pointer",fontSize:12,fontWeight:600,color:C.gold}}>
                {t.exportBtn}
              </button>
            </div>
          </div>
          ...
          <div style={{textAlign:"center",marginTop:16}}>
            <a href="mailto:gonrobtor@gmail.com" style={{fontSize:11,color:C.inkLight,textDecoration:"none"}}>✉️ gonrobtor@gmail.com</a>
          </div>

          <p style={{fontSize:11,color:C.inkLight,textAlign:"center",marginTop:8,lineHeight:1.5}}>{t.disclaimer}</p>

          <button onClick={reset}
            style={{width:"100%",marginTop:14,padding:"12px",background:"transparent",
              color:C.accent,border:`1.5px solid ${C.accent}`,borderRadius:12,fontSize:14,fontWeight:600,cursor:"pointer"}}>
            {t.newDoc}
          </button>
        </div>
      )}
